...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="PhysicalDataReaderLib",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif


SWIFT_CLASS("_TtC21PhysicalDataReaderLib14FaceController")
@interface FaceController : NSObject
...
@interface FaceController (SWIFT_EXTENSION(PhysicalDataReaderLib)) <ARSessionDelegate>
...
SWIFT_CLASS("_TtC21PhysicalDataReaderLib15WatchController")
@interface WatchController : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class WCSession;

@interface WatchController (SWIFT_EXTENSION(PhysicalDataReaderLib)) <WCSessionDelegate>
